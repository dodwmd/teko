...
return [
    ...
    */
    'tables' => [
        'roles' => 'laratrust_roles',
        'permissions' => 'laratrust_permissions',
        'permission_role' => 'laratrust_permission_role',
        'permission_user' => 'laratrust_permission_user',
        'role_user' => 'laratrust_role_user',
        'teams' => 'teams',
    ],
