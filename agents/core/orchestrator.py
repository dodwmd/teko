...
class Orchestrator:
    ...
    def create_agent(self, agent_type: str, name: str, config: Dict[str, Any] = None) -> Optional[BaseAgent]:
        """
    ...
    def _process_tasks(self) -> None:
        ...
        while self.running:
            ...
            try:
                # Process the task
                self.logger.info(f"Agent '{agent.name}' processing task {task.get('id', 'unknown')}")
